    ...
    public static class TdsMetaType
    {
        ...
        public class MetaDataRead
        {
            ...
            internal static readonly Dictionary<int, MetaDataRead> Lookup = new Dictionary<int, MetaDataRead>()
            {
                ...
                {TdsEnums.SQLUDT                    , new MetaDataRead {LenBytes=2, HasScale = false, HasPrecision = false , HasCollation = false, IsTextOrImage = false,  IsPlp = false,  SqlDbType = SqlDbType.Udt                  }},
