...
{
    public static partial class NegotiateStreamPal
    {
        public static int QueryMaxTokenSize(string package)
        {
            return SSPIWrapper.GetVerifyPackageInfo(GlobalSSPI.SSPIAuth, package, true).MaxToken;
        }

        public static SafeFreeCredentials AcquireDefaultCredential(string package, bool isServer)
        {
        ...
        {
            var outContextFlags = Interop.SspiCli.ContextFlags.Zero;
            var winStatus = (Interop.SECURITY_STATUS)SSPIWrapper.InitializeSecurityContext(
                GlobalSSPI.SSPIAuth,
                credentialsHandle,
                ref securityContext,
                spn,
        ...
        public static SecurityStatusPal CompleteAuthToken(
            ref SafeDeleteContext securityContext,
            SecurityBuffer[] inSecurityBufferArray)
        {
